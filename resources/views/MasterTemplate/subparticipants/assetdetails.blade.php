    ...
    <!-- Content Panel -->
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="col-md-6">
              {{GetTemplateName($participant_collection->template_id,$participant_collection->user_id)}}
            </div>
              </div>
              <hr>
          </div>
          ...
          <div class="col-sm-12">
            ...
            <div class="col-md-6">
              {{$participant_collection->invitee->name}}
            </div>
          </div>
              <hr>
          </div>
          ...
          <div class="col-sm-12">
            ...
            <strong>Location of the Asset</strong>
              ...
              @if($participant_collection->participant->location)
              <div class="col-md-6">
                {{$participant_collection->participant->location}}
                 <div id="map_canvas"></div>
                  <script>

                  function initMap() {
                    var myLatLng = {lat: {{$participant_collection->participant->latitude}}, lng: {{$participant_collection->participant->longitude}} };
