...
<div class="main-contents">
    <div class="container-fluid">
        ...
        @php 
          ...
          $added_subtitle = Breadcrumbs::render('master-template-participants-readonly', $Asset->id);
        @endphp
                              ...
                              @include('admin.layouts.errors')
                                ...
                                @if($FormTemplate !== null)
                                  <div class="participants-responses">
                                      {!! Form::model($Asset , ['method'=>'PATCH','enctype'=>'multipart/form-data', 'class'=>'formfields-submit form-horizontal', 'action'=>['AssetController@update', $Asset->id]]) !!}
