                            ...
                            @if(isset($permission))
                                @if(getModulePermission($module['id'],$permission) != 0)
                                  <div class="col-md-4 col-sm-6 Smodule">
                                    <a href="#" participant-id="{{$participant_id}}" invitee-id="{{$invitee_id}}" module-id="{{nxb_encode($module['id'])}}"  template-id="{{nxb_encode($module['template_id'])}}" class="module-holder modules-clicked">
