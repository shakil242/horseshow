...
@section('main-content')
    ...
    @if($FormTemplate !== null)
        <div class="participants-responses">
            ...
            {!! Form::model($invoice , ['method'=>'POST','enctype'=>'multipart/form-data', 'class'=>'formfields-submit','url'=>'master-template/invoice/save/penaltyinvoice']) !!}
