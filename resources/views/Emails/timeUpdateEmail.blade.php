    ...
    <table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
        ...
        <tr>
            <td style="padding-top:20px;">
                <p style="color:#6a6a6a;font-size:16px;line-height:14px;font-family:Arial, sans, serif;">Hi <strong style="color:#001E46;font-size:16px;line-height:16px;font-family:Arial, sans, serif;text-transform:capitalize">{{ $user->userName }},</strong></p>
        ...
        <tr>
            <td style="padding-top:10px;padding-bottom:20px;">
                ...
                <p style="color:#6a6a6a;font-size:16px;line-height:18px;font-family:Arial, sans, serif;">Your time has been rescheduled by {{$reminderMinutes}} Minutes for {{$horse_title}}.</p>
                ...
                {{--<p style="color:#6a6a6a;font-size:16px;line-height:22px;font-family:Arial, sans, serif;">--}}
                    {{--Changed from <strong style="color:#001E46;font-size:16px;line-height:16px;font-family:Arial, sans, serif;">{{ Carbon\Carbon::parse($time_slot[0])->format('m-d-Y H:i:s') }}--}}
                         {{--to {{ Carbon\Carbon::parse($timeFrom)->format('m-d-Y H:i:s') }}</strong> <br> for Class <strong>{{$asset_title}}</strong> </p>--}}
