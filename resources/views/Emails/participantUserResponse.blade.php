      ...
      <table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
        ...
        <tr>
          <td style="padding-top:20px;">
            <p style="color:#6a6a6a;font-size:16px;line-height:14px;font-family:Arial, sans, serif;">Hi <strong style="color:#001E46;font-size:16px;line-height:16px;font-family:Arial, sans, serif;text-transform:capitalize">{{ getUserNamefromid($event->invitee_id) }},</strong></p>
        ...
        <tr>
          <td style="padding-top:20px;padding-bottom:20px;">
            <p style="color:#6a6a6a;font-size:16px;line-height:14px;font-family:Arial, sans, serif;"> <strong style="color:#001E46;font-size:16px;line-height:16px;font-family:Arial, sans, serif;">{{$event->name}}</strong> has 
              @if($event->status == 1)
              ...
              @endif
              for asset ( {{ GetAssetNamefromId($event->asset_id) }} ) </p>
          </td>
        </tr>
        <tr>
        </tr>
