      ...
      <table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
        ...
        <tr>
          <td style="padding-top:20px;padding-bottom:20px;">
            <p style="color:#6a6a6a;font-size:16px;line-height:14px;font-family:Arial, sans, serif;"> <strong style="color:#001E46;font-size:16px;line-height:16px;font-family:Arial, sans, serif;">{{getUserNamefromid($data->invited_by)}}</strong> has invited you to use our application  <strong style="color:#001E46;font-size:16px;line-height:16px;font-family:Arial, sans, serif;">{{GetTemplateName($data->template_id)}}</strong>.</p>
          </td>
        </tr>
        <tr>
          <td>
            <table cellspacing="0" cellpadding="0" border="0" style="width:100%;">
              <tr>
                <td style="background:#001E46;text-align:center">
                  <a href="{{URL::to('template/sendInvite/response') }}/{{ nxb_encode($event->id) }}/1" style="font-family:Arial, sans, serif;background:#001E46;text-align:center;color:#ffffff;display:block;padding:10px;text-decoration:none;">
                ...
                <td style="background:#c6c6c6;text-align:center">
                  <a href="{{URL::to('template/sendInvite/response') }}/{{ nxb_encode($event->id) }}/2" style="font-family:Arial, sans, serif;background:#c6c6c6;text-align:center;color:#001E46;display:block;padding:10px;text-decoration:none;">
