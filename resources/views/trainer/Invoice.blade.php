                       ...
                       <div class="Totals row">
                           ...
                           <div class="col-sm-12">
                             <div class="col-sm-6 pull-right">
                              <div class="col-sm-5 border-bottom"><b> (Assets+Additonal)-Prize: </b></div>
                              ...
                              @if(isset($splitPrice))
                              <div class="col-sm-5 border-bottom"><b> Total + Split Charges: </b></div>
                              <div class="col-sm-7 addTotalPrice border-bottom">($) {{$total}} + {{$splitPrice}} = {{$total = $total+$splitPrice}}</div>
                              @endif
                              ...
                              <div class="col-sm-7 addTotalPrice border-bottom">($) {{$total}} <input type="hidden" class="totalPrice" name="total_price" value="{{$total}}"></div>
                                 ...
                                 <div class="col-sm-10">
                                     ...
                                     <div class="col-sm-7"> <a class="btn btn-lg btn-primary checkout"
                                       ...
                                       <div class="col-sm-5">
                                        <label><input type="checkbox" class="btn btn-lg btn-primary pay-in-office" data-invoice="{{nxb_encode($invoice->id)}}" name="payInOffice" value="1" @if($invoice->payinoffice == 1) checked="checked" @endif > Pay in office</label>
                                      </div>
                                 </div>
                              </div>
                           </div>
