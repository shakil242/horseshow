                                    ...
                                    <?php $splitPrice = 0; ?>
                                          ...
                                          @if($splite_additional)
                                            ...
                                            <tr class="tr-row additiona-charges-row">
                                                ...
                                                <td><strong class="visible-xs">Total Price</strong>@if(isset($pResponse->price)) <div class="priceinqty"><?php $splitPrice = $splitPrice + number_format(($pResponse->price*$pResponse->qty), 2) ?>($){{ number_format(($pResponse->price*$pResponse->qty ),2) }}</div> @else No Price Set. @endif</td>
                                            </tr>
                                            @endif
                                            @endforeach
                                          @endif
