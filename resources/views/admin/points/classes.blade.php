...
@section('main-content')
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-sm-8">
                {!! Breadcrumbs::render('points-dashboard-classes') !!}
            </div>
          </div>
          <div class="row">
            <div class="info">
          ...
          <div class="form-group add">
              ...
              <div class="col-md-8">
                  <input type="text" class="form-control" id="name" name="name"
                      placeholder="Enter class category name" required>
              </div>
              <div class="col-md-4">
                            ...
                            @foreach($collection as $showtype)
                                ...
                                <tr class="showtype{{$showtype->id}}">
                                    ...
                                    <td><button class="edit-modal btn btn-info" data-id="{{$showtype->id}}"
                                        ...
                                        <a href="/admin/class/positions/{{$showtype->id}}" class="pull-left btn btn-warning" style="color:white">
                                            Positions Points 
                                        </a>
                                        </td>
                                </tr>
...
<script src="{{ asset('adminstyle/js/points-system-class.js') }}"></script>
