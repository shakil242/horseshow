...
@section('main-content')
        <div class="row">
          ...
          <div class="row">
            <div class="col-sm-8">
                {!! Breadcrumbs::render('admin-users-view') !!}
            </div>
          </div>
                        ...
                        @if(sizeof($collection)>0)
                            @foreach($collection as $user)
                                ...
                                <tr>
                                    ...
                                    <td><strong class="visible-xs">Master-Templates</strong>{{  getMasterTemplatesFromUserEmail($user['email']) }}</td>
                                    <!-- <td><strong class="visible-xs">Type</strong></td> -->
