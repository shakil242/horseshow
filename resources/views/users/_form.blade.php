                  ...
                  {!! Form::file('logo_image') !!}
                    ...
                    if (isset($design_template->logo_image)) { ?>
                      <div style="border: 1px solid;float: left;margin: 3px;padding: 5px;">
                        <a href="{{URL::to('master-template/setting/design') }}/{{ nxb_encode($design_template->id) }}/logo-delete" data-toggle="tooltip" data-placement="top" title="Delete Image" onclick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        <img src="{{ URL::asset($design_template->logo_image) }}" height="50" width="50" />
                      </div>
                    <?php } ?>
                  <div class="logo-resolution">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        ...
                        <label class="desgin-labels"> {{ Form::radio('logo_position', '2') }} <span>Bottom</span></label>
                      </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <label class="desgin-labels">{{ Form::radio('logo_allignment', '1', true) }}<span>Left</span></label>
                      </div>
                      <div class="col-sm-4">
                        <label class="desgin-labels">{{ Form::radio('logo_allignment', '2') }}<span>Center</span></label>
                      </div>
                      <div class="col-sm-4">
                        <label class="desgin-labels">{{ Form::radio('logo_allignment', '3') }}<span>Right</span></label>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-12">
              <div class="template-create">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="desgin-labels">{{ Form::radio('background_image_repeat', '1', true) }}<span>Stretch</span></label>
                    </div>
                    <div class="col-sm-4">
                      <label class="desgin-labels">{{ Form::radio('background_image_repeat', '2') }}<span>Original</span></label>
                    </div>
                    <div class="col-sm-4">
                      <label class="desgin-labels">{{ Form::radio('background_image_repeat', '3') }}<span>Repeat</span></label>
                    </div>
                  </div>
                </div>
                <div class="col-sm-2">
                  <?php 
                    if (isset($design_template->background_image)) { ?>
                      <div style="border: 1px solid;float: left;margin: 3px;padding: 5px;">
                        <a href="{{URL::to('master-template/setting/design') }}/{{ nxb_encode($design_template->id) }}/background-delete" data-toggle="tooltip" data-placement="top" title="Delete Image" onclick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        <img src="{{ URL::asset($design_template->background_image) }}" height="100" width="150" />
                      </div>
                    <?php } ?>
                </div> 
                </div>
            ...
            <div class="col-md-12">
              <div class="template-create">
                ...
                <div class="holder">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="desgin-labels">{{ Form::radio('title_font_allignment', '1',true) }}<span>Left</span></label>
                    </div>
                    <div class="col-sm-4">
                      <label class="desgin-labels">{{ Form::radio('title_font_allignment', '2') }}<span>Center</span></label>
                    </div>
                    <div class="col-sm-4">
                      <label class="desgin-labels">{{ Form::radio('title_font_allignment', '3') }}<span>Right</span></label>
                    </div>
                  </div>
                </div>
              </div>
