    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="app-actions" style="width:100%;display:block">
                    ...
                    <div class="row"> 
                    <?php 
                    if (isset($pResponse->participant->invited_profiles)) {
                      $Profiler_Forms = getFormsForProfile($template_id,2,json_decode($pResponse->participant->invited_profiles));
                    }else{
                        $Profiler_Forms = getFormsForProfile($template_id,2);
                    }
                     ?>
