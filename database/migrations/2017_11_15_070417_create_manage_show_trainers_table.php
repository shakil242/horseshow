...
class CreateManageShowTrainersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('manage_show_trainers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('manage_show_trainers');
    }
}
